  ...
  return (
    ...
    <div className='w-full flex flex-col items-center justify-center font-varela'>
      <div className='flex items-center w-full max-w-6xl px-4 py-4 md:flex-row md:gap-0'>
        <div className='w-1/4 '>
          <img src="src/assets/logo2.png" alt="icon" className='w-10 h-10'/>
        </div>
      ...
      <div className='flex w-full px-4 max-w-6xl'>
        <div className='w-1/2 flex-col items-start justify-start mt-24 text-4xl'>
          ...
          <img src="src/assets/Arrow-down.png" alt="" className='mt-10 h-32'/>
        </div>
        <div className='w-1/2 flex items-center justify-end'>
          <img src="src/assets/bg-image.png" alt=""className='w-full h-auto'/>
          <img src="src/assets/me.png" alt="overlay" className='absolute top-24 right-44 w-1/3 h-auto'/>
        </div>
      </div>
